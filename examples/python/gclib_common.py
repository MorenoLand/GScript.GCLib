...
class GCLib:
    ...
    def _bind(self):
        ...
        self.lib.gc_send_trigger_action.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_char_p, c_char_p]
        self.lib.gc_send_trigger_action.restype = c_int
        self.lib.gc_send_trigger_action_npc.argtypes = [c_void_p, c_int, ctypes.c_float, ctypes.c_float, c_char_p, c_char_p]
        self.lib.gc_send_trigger_action_npc.restype = c_int
        self.lib.gc_send_hit_objects.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_int, c_int]
        self.lib.gc_send_hit_objects.restype = c_int
        self.lib.gc_send_player_hurt.argtypes = [c_void_p, c_int, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.c_float, c_int]
        self.lib.gc_send_player_hurt.restype = c_int
        self.lib.gc_send_add_bomb.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_int, c_int, c_char_p]
        self.lib.gc_send_add_bomb.restype = c_int
        self.lib.gc_send_del_bomb.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float]
        self.lib.gc_send_del_bomb.restype = c_int
        self.lib.gc_send_item_add.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_int]
        self.lib.gc_send_item_add.restype = c_int
        self.lib.gc_send_item_take.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_int]
        self.lib.gc_send_item_take.restype = c_int
        self.lib.gc_send_item_del.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float]
        self.lib.gc_send_item_del.restype = c_int
        self.lib.gc_send_open_chest.argtypes = [c_void_p, c_int, c_int]
        self.lib.gc_send_open_chest.restype = c_int
        self.lib.gc_send_shot.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_int, c_int, c_int, c_int, c_int]
        self.lib.gc_send_shot.restype = c_int
        self.lib.gc_send_verify_file_crc.argtypes = [c_void_p, c_char_p, ctypes.c_uint]
        self.lib.gc_send_verify_file_crc.restype = c_int
        self.lib.gc_send_level_warp_modtime.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_char_p, ctypes.c_uint]
        self.lib.gc_send_level_warp_modtime.restype = c_int
        self.lib.gc_send_adjacent_level.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_adjacent_level.restype = c_int
        self.lib.gc_send_delete_npc.argtypes = [c_void_p, c_int]
        self.lib.gc_send_delete_npc.restype = c_int
        self.lib.gc_send_put_npc.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_char_p, c_char_p]
        self.lib.gc_send_put_npc.restype = c_int
        self.lib.gc_send_rc_chat.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_rc_chat.restype = c_int
        self.lib.gc_send_server_warp.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_server_warp.restype = c_int
        self.lib.gc_send_board_modify.argtypes = [c_void_p, c_int, c_int, c_int, c_int, c_int, ctypes.POINTER(ctypes.c_ushort)]
        self.lib.gc_send_board_modify.restype = c_int
        self.lib.gc_send_fire_spy.argtypes = [c_void_p, c_int, c_int]
        self.lib.gc_send_fire_spy.restype = c_int
        self.lib.gc_send_carry_throw.argtypes = [c_void_p]
        self.lib.gc_send_carry_throw.restype = c_int
        self.lib.gc_send_enter_level.argtypes = [c_void_p]
        self.lib.gc_send_enter_level.restype = c_int
        self.lib.gc_send_delete_weapon.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_delete_weapon.restype = c_int
        self.lib.gc_send_explosion.argtypes = [c_void_p, ctypes.c_float, ctypes.c_float, c_int, c_int]
        self.lib.gc_send_explosion.restype = c_int
        self.lib.gc_send_have_window.argtypes = [c_void_p, c_int, c_char_p]
        self.lib.gc_send_have_window.restype = c_int
        self.lib.gc_send_ping_answer.argtypes = [c_void_p, c_int]
        self.lib.gc_send_ping_answer.restype = c_int
        self.lib.gc_send_is_pker.argtypes = [c_void_p, c_int]
        self.lib.gc_send_is_pker.restype = c_int
        self.lib.gc_send_upload_start.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_upload_start.restype = c_int
        self.lib.gc_send_save_file.argtypes = [c_void_p, c_char_p, c_void_p, c_int]
        self.lib.gc_send_save_file.restype = c_int
        self.lib.gc_send_upload_end.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_upload_end.restype = c_int
        self.lib.gc_send_request_file_deletion.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_request_file_deletion.restype = c_int
        self.lib.gc_send_request_folder_deletion.argtypes = [c_void_p, c_char_p]
        self.lib.gc_send_request_folder_deletion.restype = c_int
        self.lib.gc_send_request_file_rename.argtypes = [c_void_p, c_char_p, c_char_p]
